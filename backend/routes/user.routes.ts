...
import {getUser , deleteUser, updatePassword , getPaymentMethod , createNewPaymentMethod , updatePaymentMethod , deletePaymentMethod , getProvidedDorm , getInfoBeforePaying , getBookings , getChats , getAllUser} from '../controller/user.control'
